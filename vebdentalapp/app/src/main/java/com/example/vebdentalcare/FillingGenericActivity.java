...
public class FillingGenericActivity extends Activity {
   ...
   // private SQLiteDatabase mDatabase;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.filling_genericlayout);
        //Toast.makeText(this, "Mobile No is " + searchTextView.getText().toString(), Toast.LENGTH_LONG).show();
        tableLayout=(TableLayout)findViewById(R.id.fillingGenericLayout);
    ...
    private void showPatientsFromDatabase() {
       ...
       // Cursor cursorPatients = database.rawQuery("select  * from "+"VEB_CASE_HISTORY"+" where "+"TREATMENT_LIST"+" LIKE \"%RPD%\" ", new String[]{});
        ...
        String[] selectionArgs = new String[] { "%Filling Generic List%"};
        ...
        Toast.makeText(FillingGenericActivity.this,"Outside Cursor",Toast.LENGTH_SHORT).show();

       if (cursorPatients.moveToFirst()) {
           Toast.makeText(FillingGenericActivity.this,"Inside Cursor",Toast.LENGTH_SHORT).show();

           do {

               Toast.makeText(FillingGenericActivity.this,"Inside do",Toast.LENGTH_SHORT).show();
    ...
    {
        startActivity(new Intent(FillingGenericActivity.this, PatientMenuActivity.class));
        finish();
        super.onBackPressed();
    }
