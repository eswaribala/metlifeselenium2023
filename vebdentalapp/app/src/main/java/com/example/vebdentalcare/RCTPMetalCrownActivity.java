...
public class RCTPMetalCrownActivity extends Activity {
   ...
   // private SQLiteDatabase mDatabase;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rctp_metal_crown);
        //Toast.makeText(this, "Mobile No is " + searchTextView.getText().toString(), Toast.LENGTH_LONG).show();
        tableLayout=(TableLayout)findViewById(R.id.rctpMetalCrownLayout);
    ...
    private void showPatientsFromDatabase() {
       ...
       // Cursor cursorPatients = database.rawQuery("select  * from "+"VEB_CASE_HISTORY"+" where "+"TREATMENT_LIST"+" LIKE \"%RPD%\" ", new String[]{});
        ...
        String[] selectionArgs = new String[] { "%RCTPOST Metal Crown%"};
        ...
        Toast.makeText(RCTPMetalCrownActivity.this,"Outside Cursor",Toast.LENGTH_SHORT).show();

       if (cursorPatients.moveToFirst()) {
           Toast.makeText(RCTPMetalCrownActivity.this,"Inside Cursor",Toast.LENGTH_SHORT).show();

           do {

               Toast.makeText(RCTPMetalCrownActivity.this,"Inside do",Toast.LENGTH_SHORT).show();
    ...
    {
        startActivity(new Intent(RCTPMetalCrownActivity.this, PatientMenuActivity.class));
        finish();
        super.onBackPressed();
    }
