...
public class RCTACeramicCrownActivity extends Activity {
   ...
   // private SQLiteDatabase mDatabase;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rcta_ceramic_crown);
        //Toast.makeText(this, "Mobile No is " + searchTextView.getText().toString(), Toast.LENGTH_LONG).show();
        tableLayout=(TableLayout)findViewById(R.id.rctaCeramicCrownLayout);
    ...
    private void showPatientsFromDatabase() {
       ...
       // Cursor cursorPatients = database.rawQuery("select  * from "+"VEB_CASE_HISTORY"+" where "+"TREATMENT_LIST"+" LIKE \"%RPD%\" ", new String[]{});
        ...
        String[] selectionArgs = new String[] { "%RCTANT Ceramic Crown%"};
        ...
        Toast.makeText(RCTACeramicCrownActivity.this,"Outside Cursor",Toast.LENGTH_SHORT).show();

       if (cursorPatients.moveToFirst()) {
           Toast.makeText(RCTACeramicCrownActivity.this,"Inside Cursor",Toast.LENGTH_SHORT).show();

           do {

               Toast.makeText(RCTACeramicCrownActivity.this,"Inside do",Toast.LENGTH_SHORT).show();
    ...
    {
        startActivity(new Intent(RCTACeramicCrownActivity.this, PatientMenuActivity.class));
        finish();
        super.onBackPressed();
    }
