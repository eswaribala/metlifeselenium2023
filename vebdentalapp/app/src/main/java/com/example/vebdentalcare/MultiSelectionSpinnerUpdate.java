...
public class MultiSelectionSpinnerUpdate extends AppCompatSpinner implements
    ...
    public MultiSelectionSpinnerUpdate(Context context) {
        super(context);
    ...
    public MultiSelectionSpinnerUpdate(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void onClick(DialogInterface dialog, int which, boolean isChecked) {
        if (selection != null && which < selection.length) {
            ...
            UpdatePatientDetailByMobileNo.selectedItems.clear();
            UpdatePatientDetailByMobileNo.selectedItems.add(buildSelectedItemString());
        } else {
