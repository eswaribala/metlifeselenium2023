...
public class OrthoActivity extends Activity {
   ...
   // private SQLiteDatabase mDatabase;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        tableLayout=(TableLayout)findViewById(R.id.orthoLayout);
    ...
    private void showPatientsFromDatabase() {
       ...
       // Cursor cursorPatients = database.rawQuery("select  * from "+"VEB_CASE_HISTORY"+" where "+"TREATMENT_LIST"+" LIKE \"%RPD%\" ", new String[]{});
        ...
        String[] selectionArgs = new String[] { "%Ortho%"};
        ...
        Toast.makeText(OrthoActivity.this,"Outside Cursor",Toast.LENGTH_SHORT).show();

       if (cursorPatients.moveToFirst()) {
           Toast.makeText(OrthoActivity.this,"Inside Cursor",Toast.LENGTH_SHORT).show();

           do {

               Toast.makeText(OrthoActivity.this,"Inside do",Toast.LENGTH_SHORT).show();
    ...
    {
        startActivity(new Intent(OrthoActivity.this, PatientMenuActivity.class));
        finish();
        super.onBackPressed();
    }
