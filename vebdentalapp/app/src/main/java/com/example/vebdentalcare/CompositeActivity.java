...
public class CompositeActivity extends Activity {
   ...
   // private SQLiteDatabase mDatabase;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        tableLayout=(TableLayout)findViewById(R.id.compositeLayout);
    ...
    private void showPatientsFromDatabase() {
       ...
       // Cursor cursorPatients = database.rawQuery("select  * from "+"VEB_CASE_HISTORY"+" where "+"TREATMENT_LIST"+" LIKE \"%RPD%\" ", new String[]{});
        ...
        String[] selectionArgs = new String[] { "%Composite%"};
        ...
        Toast.makeText(CompositeActivity.this,"Outside Cursor",Toast.LENGTH_SHORT).show();

       if (cursorPatients.moveToFirst()) {
           Toast.makeText(CompositeActivity.this,"Inside Cursor",Toast.LENGTH_SHORT).show();

           do {

               Toast.makeText(CompositeActivity.this,"Inside do",Toast.LENGTH_SHORT).show();
    ...
    {
        startActivity(new Intent(CompositeActivity.this, PatientMenuActivity.class));
        finish();
        super.onBackPressed();
    }
